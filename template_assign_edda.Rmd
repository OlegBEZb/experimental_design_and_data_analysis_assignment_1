...
Let's compute a bootstrap 97%-CI for $\mu$ using 100000 samples.
...
The calculated p-value of 0.85 is outside CI and this also tells about
rejecting $H_0$.
...
from b) at $\mu$ = 14 and μ = 13, comment.
...
right end p^r= 0.53 of the confidence interval [ p^l,p^r] for *p*.
