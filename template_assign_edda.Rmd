...
c)  Let X1,...,X26 be the sample for seeded clouds (column *seeded*).
    ...
    H0:X1,...,X26$\sim$Exp($\lambda_0$) with the parameter
    ...
    ![\\frac{1}{\\lambda}](https://wikimedia.org/api/rest_v1/media/math/render/svg/d496a9397007733fdbbb2f98433e7aab4e51ff4f){alt="\\frac{1}{\\lambda}"}
